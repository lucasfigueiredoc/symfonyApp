 ...
 */
final class Version20231225154339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aluno (id INT AUTO_INCREMENT NOT NULL, curso_id INT NOT NULL, nome VARCHAR(100) NOT NULL, dtnascimento DATE NOT NULL, telefone VARCHAR(10) NOT NULL, endereco VARCHAR(50) NOT NULL, genero TINYINT(1) NOT NULL, INDEX IDX_67C9710087CB4A1F (curso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
